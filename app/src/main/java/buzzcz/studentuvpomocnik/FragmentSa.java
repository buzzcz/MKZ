...
public class FragmentSa extends Fragment {
	 ...
	 * number.
	 */
	public static FragmentSa newInstance(int sectionNumber) {
		FragmentSa fragment = new FragmentSa();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_main_sa, container, false);
		ExpandableListView timetableListView = (ExpandableListView) rootView.findViewById(R.id
				.timetableSaExpandableListView);
