 ...
 */
public class FragmentWe extends Fragment {
	/**
	 ...
	 * number.
	 */
	public static FragmentWe newInstance(int sectionNumber) {
		FragmentWe fragment = new FragmentWe();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_main_we, container, false);
		ExpandableListView timetableListView = (ExpandableListView) rootView.findViewById(R.id
				.timetableWeExpandableListView);
